...
(function () {
  ...
  const KB = [
    ...
    { k: ['join', 'sign up', 'signup', 'become a member', 'register', 'kunyoresa', 'ukubhalisa', 'how do i get cover', 'get cover'],
      a: { en: "Joining is simple. Browse the plans page to compare Essential, Comprehensive and Corporate cover, then use the quote form — every GENFIN package is finally priced to your exact needs, so our team confirms your cover and premium before you commit. Employer groups get group billing and a dedicated account manager. Shall I take you to the plans?",
           sn: "Kujoina kuri nyore. Tarisa peji rezvirongwa uenzanise Essential, Comprehensive neCorporate, wozadza fomu yekukumbira mutengo — chirongwa chimwe nechimwe chinotarwa mutengo unoenderana newe chaizvo. Ndokuendesa kuzvirongwa here?",
           nd: "Ukujoyina kulula. Khangela ikhasi lezinhlelo uqathanise i-Essential, iComprehensive leCorporate, ubusugcwalisa ifomu yentengo — uhlelo ngalunye lubizwa intengo ehambelana lawe. Ngikuse ezinhlelweni?" },
      links: [['See plans & get a quote', 'plans.html']], c: ['What do plans cost?', 'What benefits do I get?', 'Talk to support'] },

    { k: ['cost', 'price', 'how much', 'premium', 'marii', 'yimalini', 'plan'],
      a: { en: "Indicative pricing: Essential from $29/month (core GP and acute medication cover), Comprehensive from $59/month (adds optical, dental, specialists, chronic delivery and dependants), and Corporate is custom-priced for employer groups. Your exact premium is confirmed with a quick quote because cover is tailored to you.",
           sn: "Mitengo inofungidzirwa: Essential kubva pa$29 pamwedzi, Comprehensive kubva pa$59 pamwedzi (inowedzera magirazi, mazino, nyanzvi, nekutumirwa kwemishonga), Corporate inotarirwa mapoka evashandi. Mutengo wako chaiwo unosimbiswa nequote.",
           nd: "Intengo elinganisiweyo: i-Essential kusukela ku-$29 ngenyanga, iComprehensive kusukela ku-$59 ngenyanga, iCorporate ibizwa ngokwahlukana kumaqembu abaqhatshi. Intengo yakho eqondileyo iqinisekiswa ngequote." },
